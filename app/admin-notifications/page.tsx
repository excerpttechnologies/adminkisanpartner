...
//     try {
//       setLoading(true);
//       const response = await fetch('http://localhost:8080/product/admin-notifications');
...
//       countered: <span className="badge bg-info">💬 Countered</span>,
//       paid: <span className="badge bg-success">✓ Paid</span>,
//       partial: <span className="badge bg-warning">⚠ Partial</span>,
//       processing: <span className="badge bg-primary">🔄 Processing</span>,
//       in_transit: <span className="badge bg-info">🚚 In Transit</span>,
...
//       offer: <i className="bi bi-tag-fill text-warning fs-3"></i>,
//       order_created: <i className="bi bi-cart-fill text-primary fs-3"></i>,
//       trader_payment: <i className="bi bi-arrow-down-circle-fill text-success fs-3"></i>,
//       farmer_payment: <i className="bi bi-arrow-up-circle-fill text-info fs-3"></i>,
//       transporter_update: <i className="bi bi-truck text-secondary fs-3"></i>,
//     };
//     return icons[type] || <i className="bi bi-bell-fill fs-3"></i>;
//   };
...
//                   <span className="badge bg-primary me-2">{notifications.length} Total</span>
//                   All system activities and updates
//                 </p>
//               </div>
...
//                   <i className="bi bi-tag-fill text-warning fs-1 me-3"></i>
//                   <div>
//                     <h3 className="mb-0 fw-bold">{offerCount}</h3>
...
//               <div className="card-body">
//                 <div className="d-flex align-items-center">
//                   <i className="bi bi-cart-fill text-primary fs-1 me-3"></i>
//                   <div>
//                     <h3 className="mb-0 fw-bold">{orderCount}</h3>
...
//                   <div>
//                     <h3 className="mb-0 fw-bold">{paymentCount}</h3>
//                     <small className="text-muted">Payment Activities</small>
//                   </div>
//                 </div>
//               </div>
//             </div>
...
//               <div className="card-body">
//                 <div className="d-flex align-items-center">
//                   <i className="bi bi-truck text-secondary fs-1 me-3"></i>
//                   <div>
//                     <h3 className="mb-0 fw-bold">{transporterCount}</h3>
//                     <small className="text-muted">Transporter Updates</small>
//                   </div>
//                 </div>
//               </div>
//             </div>
...
//                   </button>
//                   <button
//                     className={`btn btn-sm ${filter === 'offers' ? 'btn-warning' : 'btn-outline-warning'}`}
...
//                   </button>
//                   <button
//                     className={`btn btn-sm ${filter === 'orders' ? 'btn-primary' : 'btn-outline-primary'}`}
...
//                   </button>
//                   <button
//                     className={`btn btn-sm ${filter === 'payments' ? 'btn-success' : 'btn-outline-success'}`}
...
//                   </button>
//                   <button
//                     className={`btn btn-sm ${filter === 'transporter' ? 'btn-secondary' : 'btn-outline-secondary'}`}
...
//                               <i className="bi bi-tag text-warning me-1"></i>
...
//                               </span>
//                               <span className="badge bg-light text-dark">{notification.gradeName}</span>
//                             </div>
...
//                               <div className="col-md-4">
//                                 <small className="text-muted">Offered Price:</small>
//                                 <div className="fw-bold">₹{notification.offeredPrice} × {notification.quantity} {notification.unitMeasurement}</div>
//                                 <div className="text-success">Total: ₹{((notification.offeredPrice || 0) * (notification.quantity || 0)).toFixed(2)}</div>
//                               </div>
//                               {notification.counterPrice && (
//                                 <div className="col-md-4">
//                                   <small className="text-muted">Counter Offer:</small>
//                                   <div className="fw-bold">₹{notification.counterPrice} × {notification.counterQuantity} {notification.unitMeasurement}</div>
//                                   <div className="text-info">Total: ₹{((notification.counterPrice || 0) * (notification.counterQuantity || 0)).toFixed(2)}</div>
//                                 </div>
//                               )}
//                               <div className="col-md-4">
//                                 <small className="text-muted">Trader:</small>
//                                 <div className="fw-bold">{notification.traderName}</div>
//                                 <small className="text-muted">Farmer ID: {notification.farmerId}</small>
//                               </div>
//                             </div>
//                           </div>
//                         )}
...
//                           <div>
//                             <h6 className="fw-bold mb-2">
//                               <i className="bi bi-cart text-primary me-1"></i>
...
//                                 <small className="text-muted">Trader:</small>
//                                 <div className="fw-bold">{notification.traderName}</div>
//                                 <small className="text-muted">{notification.traderId}</small>
//                               </div>
//                               <div className="col-md-3">
//                                 <small className="text-muted">Farmer:</small>
//                                 <div className="fw-bold">{notification.farmerName}</div>
//                                 <small className="text-muted">{notification.farmerId}</small>
//                               </div>
//                               <div className="col-md-3">
//                                 <small className="text-muted">Total Amount:</small>
//                                 <div className="fw-bold text-success">₹{notification.totalAmount?.toFixed(2)}</div>
//                               </div>
//                               <div className="col-md-3">
//                                 <small className="text-muted">Payment Status:</small>
//                                 <div>{getStatusBadge(notification.paymentStatus || 'pending')}</div>
//                               </div>
//                             </div>
//                           </div>
//                         )}

//                         {/* Trader Payment Notification */}
//                         {notification.type === 'trader_payment' && (
//                           <div>
//                             <h6 className="fw-bold mb-2 text-success">
//                               <i className="bi bi-arrow-down-circle-fill me-1"></i>
//                               Payment Received from Trader
//                             </h6>
//                             <div className="d-flex flex-wrap gap-2 mb-2">
//                               <span className="badge bg-primary">
//                                 <i className="bi bi-receipt me-1"></i>
...
//                                   <strong>Amount Received:</strong> ₹{notification.amount?.toFixed(2)}
//                                 </div>
//                                 <div className="col-md-6">
//                                   <strong>Payment Date:</strong> {notification.paidDate && new Date(notification.paidDate).toLocaleString('en-IN')}
//                                 </div>
//                               </div>
//                             </div>
//                           </div>
...
//                         {notification.type === 'farmer_payment' && (
//                           <div>
...
//                               <div className="row">
//                                 <div className="col-md-6">
//                                   <strong>Amount Sent:</strong> ₹{notification.amount?.toFixed(2)}
//                                 </div>
//                                 <div className="col-md-6">
//                                   <strong>Payment Date:</strong> {notification.paidDate && new Date(notification.paidDate).toLocaleString('en-IN')}
//                                 </div>
...
//                           <div>
//                             <h6 className="fw-bold mb-2">
//                               <i className="bi bi-truck text-secondary me-1"></i>
//                               {notification.message}
//                             </h6>
//                             <div className="d-flex flex-wrap gap-2 mb-2">
//                               <span className="badge bg-primary">
...
//                               <div className="small">
//                                 <div><strong>Transporter:</strong> {notification.transporterDetails.transporterName}</div>
//                                 <div><strong>Vehicle:</strong> {notification.transporterDetails.vehicleType} - {notification.transporterDetails.vehicleNumber}</div>
//                                 {notification.transporterDetails.driverName && (
//                                   <div><strong>Driver:</strong> {notification.transporterDetails.driverName}</div>
//                                 )}
//                               </div>
//                             )}
//                           </div>
