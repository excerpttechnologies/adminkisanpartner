...
//   // Filter sliders based on status and search
//   const filteredSliders = sliders.filter(slider => {
//     const matchesStatus = filterStatus === 'all' || slider.status === filterStatus
//     const matchesSearch = slider.title.toLowerCase().includes(searchTerm.toLowerCase()) ||
//                          slider.role.toLowerCase().includes(searchTerm.toLowerCase())
...
//     if (newSlider.title && newSlider.role && newSlider.image) {
//       const slider: Slider = {
//         id: sliders.length + 1,
...
//           <p className="text-gray-600 mt-2">Manage and organize your sliders</p>
//         </div>
...
//             <p className="text-2xl font-bold text-gray-900">{totalSliders}</p>
//           </div>
...
//                   to{' '}
//                   <span className="font-medium">
//                     {Math.min(currentPage * itemsPerPage, filteredSliders.length)}
//                   </span>{' '}
//                   of{' '}
//                   <span className="font-medium">{filteredSliders.length}</span>{' '}
//                   results
//                 </p>
//               </div>
//               <div>
...
//                     <input
//                       type="text"
//                       value={newSlider.role}
//                       onChange={(e) => setNewSlider({ ...newSlider, role: e.target.value })}
//                       className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
//                       placeholder="Enter slider role"
//                     />
//                   </div>
...
//                       disabled={!newSlider.title || !newSlider.role || !newSlider.image}
//                       className={`flex-1 px-4 py-2 rounded-lg transition-colors ${
//                         newSlider.title && newSlider.role && newSlider.image
