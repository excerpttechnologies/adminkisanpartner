...
//     setLoading(true);
//     try {
//       // Process pest images first
//       const processedPests = await Promise.all(
//         validPests.map(async (pest) => {
//           if (pest.imageFile) {
//             // Convert image to base64 for now
//             // In production, you'd want to upload to server separately
//             const base64Image = await fileToBase64(pest.imageFile);
//             return {
//               name: pest.name.trim(),
//               image: base64Image // Store as base64 or upload to server
//             };
//           }
//           return {
//             name: pest.name.trim(),
...
//           if (seed.imageFile) {
//             const base64Image = await fileToBase64(seed.imageFile);
//             return {
//               name: seed.name.trim(),
//               image: base64Image, // Store as base64 or upload to server
...
//       formData.append('status', 'active');
//       formData.append('targetPestsDiseases', JSON.stringify(processedPests));
//       formData.append('recommendedSeeds', JSON.stringify(processedSeeds));
                ...
                <div key={index} className="dynamic-field-group">
                  ...
                  <div className="form-group">
                    ...
                    <div className="image-upload-container">
                      {/* <input
                        type="file"
                        ref={el => { pestImageInputRefs.current[index] = el; }} onChange={(e) => handlePestImageUpload(index, e)}
                        accept="image/*"
                        className="file-input"
                        disabled={loading}
                      /> */}
                ...
                <div key={index} className="dynamic-field-group">
                  ...
                  <div className="form-group">
                    ...
                    <div className="image-upload-container">
                      {/* <input
                        type="file"
                        ref={el => { seedImageInputRefs.current[index] = el; }} onChange={(e) => handleSeedImageUpload(index, e)}
                        accept="image/*"
                        className="file-input"
                        disabled={loading}
                      /> */}
