...
//   deliveryDate: string;
//   deliveryTime: string;
//   nearestMarket: string | MarketDetails; // Can be string ID or full object
//   createdAt: string;
...
//     if (item.marketDetails) {
//       return item.marketDetails;
//     }
    
//     // Check if nearestMarket is already an object
//     if (typeof item.nearestMarket === 'object' && item.nearestMarket !== null) {
//       return item.nearestMarket as MarketDetails;
//     }
...
//       const totalValue = item.pricePerUnit * item.totalQty;
//       const marketDetails = getMarketDetails(item);
...
//         "Sub Category ID": item.subCategoryId,
//         "Grade": item.grade,
...
//         "Market ID": marketDetails?.marketId || (typeof item.nearestMarket === 'string' ? item.nearestMarket : ''),
//         "Market Name": marketDetails?.marketName || '',
//         "Market District": marketDetails?.district || '',
//         "Market State": marketDetails?.state || '',
//         "Market Pincode": marketDetails?.pincode || '',
//       };
//     });
...
//                     <div className="text-sm font-medium">{item.categoryId}</div>
//                   </div>
//                   <div>
//                     <div className="text-xs text-gray-500">Sub Category ID</div>
//                     <div className="text-sm font-medium">{item.subCategoryId}</div>
//                   </div>
//                   <div>
...
//                       <span className="font-medium">{currentItem.categoryId}</span>
//                     </div>
//                     <div className="flex justify-between">
...
//                     </div>
//                     <div className="flex justify-between">
//                       <span className="text-gray-600">Sub Category ID:</span>
//                       <span className="font-medium">{currentItem.subCategoryId}</span>
//                     </div>
//                     <div className="flex justify-between">
//                       <span className="text-gray-600">Sub Category Name:</span>
...
//                       <span className="font-medium">{formatDate(currentItem.deliveryDate)}</span>
//                     </div>
//                     <div className="flex justify-between">
//                       <span className="text-gray-600">Delivery Time:</span>
//                       <span className="font-medium">{currentItem.deliveryTime}</span>
//                     </div>
//                   </div>
//                 </div>
...
//                   </h3>
//                   {(() => {
//                     const marketDetails = getMarketDetails(currentItem);
...
//                             <span className="font-medium">{marketDetails.marketId}</span>
//                           </div>
//                           <div className="flex justify-between">
//                             <span className="text-gray-600">Market Name:</span>
//                             <span className="font-medium">{marketDetails.marketName}</span>
//                           </div>
//                           <div className="flex justify-between">
//                             <span className="text-gray-600">Pincode:</span>
//                             <span className="font-medium">{marketDetails.pincode}</span>
//                           </div>
//                           <div className="flex justify-between">
//                             <span className="text-gray-600">District:</span>
//                             <span className="font-medium">{marketDetails.district}</span>
//                           </div>
//                           <div className="flex justify-between">
//                             <span className="text-gray-600">State:</span>
//                             <span className="font-medium">{marketDetails.state}</span>
//                           </div>
//                           {marketDetails.place && (
//                             <div className="flex justify-between">
//                               <span className="text-gray-600">Place:</span>
//                               <span className="font-medium">{marketDetails.place}</span>
//                             </div>
//                           )}
//                           {marketDetails.postOffice && (
//                             <div className="flex justify-between">
//                               <span className="text-gray-600">Post Office:</span>
//                               <span className="font-medium">{marketDetails.postOffice}</span>
//                             </div>
//                           )}
//                           {marketDetails.exactAddress && (
//                             <div className="flex justify-between">
//                               <span className="text-gray-600">Address:</span>
//                               <span className="font-medium text-sm">{marketDetails.exactAddress}</span>
//                             </div>
//                           )}
//                           {marketDetails.landmark && (
//                             <div className="flex justify-between">
//                               <span className="text-gray-600">Landmark:</span>
//                               <span className="font-medium">{marketDetails.landmark}</span>
//                             </div>
//                           )}
//                         </div>
//                       );
//                     } else if (typeof currentItem.nearestMarket === 'string') {
//                       return (
//                         <div className="space-y-3">
//                           <div className="flex justify-between">
//                             <span className="text-gray-600">Market ID:</span>
