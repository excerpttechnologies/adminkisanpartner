...
const initialPages = [
  {
    ...
    name: "Privacy Policy",
    content:
      "<h1>Privacy Policy</h1><p>Your privacy is important to us. This privacy policy explains what personal data we collect and how we use it.</p>",
  },
  {
    id: 2,
    name: "Terms & Conditions",
    content:
      "<h1>Terms & Conditions</h1><p>Please read these terms and conditions carefully before using our service.</p>",
  },
  {
    id: 3,
    name: "About Us",
    content:
      "<h1>About Us</h1><p>We are a company dedicated to providing the best services to our customers.</p>",
  },
  {
    id: 4,
    name: "Refund Policy",
    content:
      "<h1>Refund Policy</h1><p>Our refund policy ensures customer satisfaction with clear guidelines for returns and refunds.</p>",
  },
  {
    id: 5,
    name: "Shipping Policy",
    content:
      "<h1>Shipping Policy</h1><p>Learn about our shipping methods, delivery times, and shipping costs.</p>",
  },
  {
    id: 6,
    name: "Contact Us",
    content:
      "<h1>Contact Us</h1><p>Get in touch with our support team for any queries or assistance.</p>",
  },
];
...
const stripHtmlTags = (html: string): string => {
  ...
  // Client-side: Use DOM API for more accurate results
  const tmp = document.createElement("div");
  tmp.innerHTML = html;
  return tmp.textContent || tmp.innerText || "";
};
      ...
      <Modal open={open} onClose={() => !loading && setOpen(false)}>
        <Box sx={modalStyle}>
          ...
          <div className="mb-6">
            ...
            <Typography variant="caption" className="text-gray-500 mt-2 block">
              Use the toolbar to format your content. Supports text formatting,
