...
import { , CropCareCategory } from '@/app/models/cropcare';
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('Creating  with data:', body);
    ...
    console.log(' created successfully:', subcategory._id);
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    const subcategory = await .findByIdAndDelete(id);
