...
const Sidebar = () => {
  ...
  return (
    <div className=" shadow  border-zinc-200 bg-white overflow-y-scroll pb-20">
      {/* Mobile Toggle */}
      <button
      ...
      >
        ...
        <nav className="flex flex-col  px-5 mt-3 mb-20">
  {menu.map((group, i) => (
    <div key={i} className={` ${i==0?"border-t-0":"border-t"} mt-3 border-zinc-200`}>
      {/* Section Title */}
      <p className="text-xs mt-4 ml-2  font-semibold text-[#353434]  mb-2">
        {group.section}
      </p>
