              ...
              <div className="flex flex-col gap-1">
                {group.items.map((item, j) => (
                  <Link
                    key={j}
                    href={item.path}
                    onClick={() => {setOpen(false)setChange}}
                    className={`flex items-center gap-3 px-3 ${window.location.pathname == item.path&&"bg-green-50 text-green-500"} py-2 rounded-lg text-sm text-gray-600
