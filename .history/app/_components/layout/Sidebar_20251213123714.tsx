...
const Sidebar = () => {
  ...
  return (
    <div className=" shadow  border-zinc-200 bg-white  pb-2">
     ...
     <div className="h-[85vh] mt-[8vh] border-t overflow-scroll">
       {/* Sidebar */}
      <aside
      ...
      >
        ...
        <nav className="flex  overflow-y-scroll flex-col  px-5  mb-20">
  {menu.map((group, i) => (
    <div key={i} className={` ${i==0?"border-t-0":"border-t mt-3"}  border-zinc-200`}>
      {/* Section Title */}
      <p className={`text-xs mt-4 ml-2 ${i==0?"border-t-0":"border-t mt-3"} font-semibold text-[#353434]  mb-2`}>
        {group.section}
      </p>
