...
const Todo = () => {
 ...
 {/* /////form */}
      <div className='w-96 mt-5 border border-zinc-200 h-fit p-4 flex  justify-center items-center bg-white rounded shadow '>
        <input value={} onChange={(e)=>setTodo(e.target.value)} placeholder='Add todo' type="text" name="" id=""  className='w-full h-full outline-none border  border-zinc-400 rounded p-4'/>
