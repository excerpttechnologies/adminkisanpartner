...
export default function RequirementsPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await axios.delete(`/api/requirements?id=${selected._id}`);
  ...
  return (
    <div className="min-h-screen overflow-x-auto bg-gray-50 text-gray-900 p-3 md:p-1">
      {/* Header */}
      <div className="mb-8">
      ...
      <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
        ...
        <div className="p-5 border-b border-gray-200">
          <div className="flex flex-col lg:flex-row gap-4">
            {/* Search */}
            <div className="flex-1 flex justify-between gap-y-3">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="inline-flex items-center gap-2 px-5 py-3 border border-gray-300 rounded-xl hover:bg-gray-50 transition-colors"
              >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="flex items-end">
                  <button
                    ...
                    className="w-full px-4 py-2.5 text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors"
                  >
                    Clear Filters
                  </button>
                </div>
      ...
      <Dialog open={editOpen} onClose={() => setEditOpen(false)} maxWidth="sm" fullWidth>
        <div className="p-6">
          ...
          <p className="text-gray-600 text-sm mb-6">Update the requirement details</p>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => setSelected(prev => prev ? {...prev, category: e.target.value} : null)}
                className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => setSelected(prev => prev ? {...prev, status: e.target.value as 'Active' | 'Inactive'} : null)}
                className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
              >
                <option value="Active">Active</option>
                <option value="Inactive">Inactive</option>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setSelected(prev => prev ? {...prev, weightPerPack: parseFloat(e.target.value)} : null)}
                className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
                min="0"
                step="0.1"
              />
