            ...
            <div className="flex-1 flex gap-x-3 gap-y-3">
              <div className="relative">
                ...
                <input
                  ...
                  className="lg:w-[30vw] md:w-80 pl-12 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all"
                />
              </div>
               <select
                    value={rowsPerPage}
