    ...
    <div className="min-h-screen  p-4 md:p-6">
      ...
      <div className="mb-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <button className="inline-flex w-fit items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-green-600 to-green-600 text-white font-medium rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 shadow-lg hover:shadow-xl">
            ...
            <tbody className="divide-y divide-gray-200">
              {paginatedRows.map((row) => (
                <tr key={row.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-3 whitespace-nowrap text-sm text-gray-700">{row.seed}</td>
                  <td className="px-6 py-3 whitespace-nowrap">
                    <span className="text-sm font-medium text-gray-900">{row.quantity}</span>
                  </td>
                  <td className="px-6 py-3 whitespace-nowrap text-sm text-gray-700">{row.quality}</td>
                  <td className="px-6 py-3 whitespace-nowrap">
...
<div className="flex items-center justify-center p-4">
      ...
      <Dialog sx={{background:"transparent"}} open={deleteOpen}>
 <div className="  z-50 flex items-center justify-center p-4  bg-transparent">
          <div className=" rounded-2xl shadow-2xl max-w-md w-full">
            <div className="p-6 border-b border-gray-200">
              <h3 className="text-xl font-semibold text-gray-900">Confirm Deletion</h3>
            </div>
