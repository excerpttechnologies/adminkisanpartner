    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4 md:p-6">
      ...
      <div className="mb-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <button className="inline-flex w-fit items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-green-600 to-indigo-600 text-white font-medium rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 shadow-lg hover:shadow-xl">
            ...
            <tbody className="divide-y divide-gray-200">
              {paginatedRows.map((row) => (
                <tr key={row.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{row.seed}</td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className="text-sm font-medium text-gray-900">{row.quantity}</span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{row.quality}</td>
                  <td className="px-6 py-4 whitespace-nowrap">
