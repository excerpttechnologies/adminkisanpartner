    ...
    <div className="min-h-screen  p-4 md:p-6">
      ...
      <div className="mb-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <button className="inline-flex w-fit items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-green-600 to-green-600 text-white font-medium rounded-lg hover:from-green-700 hover:to-indigo-700 transition-all duration-200 shadow-lg hover:shadow-xl">
