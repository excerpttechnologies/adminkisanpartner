...
export default function RequirementsPage() {
 ...
 const updateStatus=async(id:string)=>{
  ...
  return (
    <div className="min-h-screen overflow-x-auto bg-gray-50 re text-gray-900  md:p-1">
      {/* Header */}
     {
      loading&&<div className="min-h-screen absolute top-0 left-0  flex items-center justify-center">
        <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-blue-500"></div>
      </div>
     }
      <div className="mb-3">
            ...
            <div className="flex-1 flex gap-x-3 gap-y-3">
              <div className="relative">
                ...
                <input
                  ...
                  className="lg:w-[30vw] md:w-80 w-72 pl-12 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all"
                />
              </div>
               <select
                    value={rowsPerPage}
                    onChange={(e) => setrowsPerPage(Number(e.target.value))}
                    className="w-fit px-2 py-1 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
                  >
