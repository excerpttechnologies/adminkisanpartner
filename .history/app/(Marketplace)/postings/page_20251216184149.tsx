                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div className="sm:col-span-2 lg:col-span-1 flex items-end">
                    <button
                      ...
                      className="w-fit bg-green-400 px-4 py-2.5 text-sm   border border-green-300 text-white rounded-lg font-bold hover:bg-green-600 cursor-pointer transition-colors font-medium"
                    >
                      Clear Filters
                    </button>
                  </div>
