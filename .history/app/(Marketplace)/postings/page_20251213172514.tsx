          ...
          <div>
            ...
            <div className="flex items-center gap-3 mt-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[] text-gray-600">Approved</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 rounded-full bg-amber-500"></div>
                <span className="text-[] text-gray-600">Pending</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 rounded-full bg-rose-500"></div>
                <span className="text-[] text-gray-600">Rejected</span>
              </div>
            </div>
          </div>
          <button
          ...
          {showFilters && (
            <div className="mt-6 p-5 bg-gradient-to-r from-gray-50 to-gray-100 rounded border border-gray-200">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                <div>
                  <label className="block text-[] font-semibold text-gray-700 mb-2">
                    Status
                  </label>
                  <select
                    value={filterStatus}
            ...
            <tbody className="divide-y divide-gray-200">
              {paginatedData.map((row) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-[] font-medium text-gray-900">
                    {row.item}
                  </td>
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2">
                      <FaSeedling className="w-4 h-4 text-emerald-500" />
                      <span className="text-[] text-gray-700">{row.seed}</span>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <span className="inline-flex items-center px-3 py-1 rounded-lg text-[] font-medium bg-amber-50 text-amber-700">
                      {row.acres}
                    </span>
                  </td>
                  <td className="px-6 py-4">
                    <div className="flex items-center">
                      <div className="w-8 h-8 rounded-full bg-gradient-to-r from-blue-500 to-indigo-500 flex items-center justify-center text-white text-[] font-semibold mr-3">
      ...
      <div className="p-6 border-b border-gray-200">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 text-[] mt-1">Complete information about this posting</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="space-y-4">
          {Object.entries(row).map(([key, value]) => (
            <div key={key} className="flex justify-between items-center py-2 border-b border-gray-100 last:border-0">
              <span className="text-[] font-medium text-gray-700 capitalize">
                {key.replace(/([A-Z])/g, " $1")}:
              </span>
              <span className="text-[] text-gray-900 font-medium">{value}</span>
            </div>
          ))}
        </div>
      </div>
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50">
    <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full">
      <div className="p-6 border-b border-gray-200">
        ...
        <p className="text-gray-600 text-[] mt-1">Update the posting information</p>
      </div>
      <div className="p-6 space-y-4">
        <div>
          <label className="block text-[] font-medium text-gray-700 mb-2">Title</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-[] font-medium text-gray-700 mb-2">Status</label>
          <select
        ...
        <div>
          <label className="block text-[] font-medium text-gray-700 mb-2">Acres</label>
          <input
            type="text"
      ...
      <div className="p-6 border-b border-gray-200">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-600 text-[] mt-1">This action cannot be undone</p>
          </div>
        </div>
      </div>
      <div className="p-6">
