      ...
      <div className="bg-white rounded shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="p-3 sm:p-4 md:p-6 border-b border-gray-200">
          <div className="flex flex-col gap-3">
            {/* Search */}
            <div className="relative flex lg:flex-row flex-col gap-x-3">
             <div className="relative">
              ...
              <input
                ...
                className="w-96 lg:w-full pl-10 pr-4 py-2.5 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none"
              />
             </div>
