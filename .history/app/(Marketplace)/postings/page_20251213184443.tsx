...
export default function PostingTable() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white p-2 sm:p-3 md:p-4 lg:p-6">
      {/* Mobile Menu Overlay */}
      {showMobileMenu && (
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            <button 
              ...
              className="lg:hidden p-2 rounded-lg bg-white border shadow-sm"
            >
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1 sm:gap-2">
                <TooltipButton
                  icon={<FaCopy className="w-4 h-4 sm:w-5 sm:h-5" />}
                  onClick={copyData}
                  tooltip="Copy Data"
                  mobile
                />
                <TooltipButton
                  icon={<FaFileExcel className="w-4 h-4 sm:w-5 sm:h-5" />}
                  onClick={exportExcel}
                ...
                />
                <TooltipButton
                  icon={<FaPrint className="w-4 h-4 sm:w-5 sm:h-5" />}
                  onClick={printTable}
                  tooltip="Print"
                  mobile
                />
...
const ViewModal = ({ row, onClose }: { row: Posting; onClose: () => void }) => (
  <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black bg-opacity-50">
    <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl max-w-md w-full max-h-[90vh] overflow-hidden">
