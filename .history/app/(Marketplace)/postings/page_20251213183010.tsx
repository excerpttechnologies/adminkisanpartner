              ...
              {paginatedData.map((row) => (
                ...
                >
                  <td className="px-6 py-2">
                    <div className="flex items-center gap-2">
                      <FaCalendarAlt className=" h-4 text-gray-400" />
                      <span className="text-[12px] w-20 font-medium text-gray-900">
                        {row.date}
                      </span>
                    </div>
                  </td>
                  <td className="px-6 py-2">
                    <div className="text-[12px] w-28 font-semibold text-gray-900">
                      {row.title}
                    </div>
                  </td>
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-transparent bg-opacity-50">
    <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-hidden">
      ...
      <div className="p-6 border-t border-gray-200">
        <button
          onClick={onClose}
          className="w-full px-4 py-2 bg-gradient-to-r from-green-600 to-green-600 text-white rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all font-medium"
        >
          Close Details
        </button>
      </div>
