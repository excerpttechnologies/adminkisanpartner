...
export default function PostingTable() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b relative overflow-x-scroll from-gray-50 to-white text-black p-2">
      {
        loading && postings.length === 0 &&<div className="min-h-screen absolute z-[100] top-0 left-0 bg-gradient-to-b from-gray-50 to-white flex items-center justify-center">
        <CircularProgress />
      </div>
  }
