...
export default function OrdersPage() {
  ...
  return (
    <div className="p-2 md:p-6  min-h-screen">
      ...
      {/* Filters Section */}
      <div className="bg-white rounded shadow p-2 md:p-6 mb-6">
      ...
      {/* Export Buttons */}
      <div className="flex flex-wrap gap-2 mb-6 bg-white p-2 rounded shadow">
        {[
      ...
      <div className="bg-white rounded shadow-lg overflow-hidden" ref={tableRef}>
          ...
          <table className="w-full">
            <thead className=" border-b border-zinc-200">
              <tr className="*:text-zinc-800">
                ...
                <th className="p-2 text-left  font-semibold">Crop Detail</th>
                <th className="p-2 text-left  font-semibold">Ordered By</th>
                <th className="p-2 text-left  font-semibold">Status</th>
                <th className="p-2 text-left  font-semibold">Delivery</th>
            ...
            <tbody className="divide-y divide-gray-100">
              {filteredOrders.map((order, i) => (
                <tr key={order.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="p-2">{order.orderedBy}</td>
                  <td className="p-2">
                  ...
                  <td className="p-2 text-sm text-gray-700">{order.delivery}</td>
                  <td className="p-2">
                    <span className="px-2 py-1 bg-gray-100  rounded text-sm">
                      {order.payment}
                    </span>
                  </td>
                  <td className="p-2 font-bold text-green-700">{order.amount}</td>
                  <td className="p-2">
        ...
        <div className="lg:hidden  space-y-4 p-2">
          {filteredOrders.map((order, i) => (
            <div key={order.id} className=" rounded p-2 border border-zinc-200 shadow">
