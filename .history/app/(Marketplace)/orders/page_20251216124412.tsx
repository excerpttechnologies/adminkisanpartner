          ...
          <div className="md:col-span-4">
            <div className="relative">
              ...
              <input
                ...
                className="md:w-96 pl-10 pr-4 py-3 border border-gray-300 rounded focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition-all"
              />
            </div>
          </div>
