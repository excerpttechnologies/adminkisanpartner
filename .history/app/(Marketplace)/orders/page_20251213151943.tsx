...
export default function OrdersPage() {
  ...
  const handleConfirmDelete = () => {
    setOrders(prev => prev.filter(order => order.id !== currentOrder.));
  ...
  return (
    <div className="p-4 md:p-6 bg-gradient-to-br from-gray-50 to-green-50 min-h-screen">
      {/* Header */}
      <div className="mb-8">
      ...
      <div className="flex flex-wrap gap-3 mb-6">
        {[
          ...
          <button
            key={i}
            onClick={btn.onClick}
            className={`flex items-center gap-2 px-4 py-3 rounded-lg transition-all duration-200 shadow-sm hover:shadow-md ${btn.color} font-medium`}
          >
      ...
      {/* Table Section */}
      <div className="bg-white rounded-xl shadow-lg overflow-hidden" ref={tableRef}>
        {/* Desktop Table */}
        <div className="hidden lg:block overflow-x-auto">
          <table className="w-full">
            <thead className="bg-gradient-to-r from-gray-50 to-green-50">
              <tr>
                <th className="p-4 text-left text-gray-700 font-semibold">Sr.</th>
                <th className="p-4 text-left text-gray-700 font-semibold">Date</th>
                <th className="p-4 text-left text-gray-700 font-semibold">Crop Detail</th>
                <th className="p-4 text-left text-gray-700 font-semibold">Ordered By</th>
                <th className="p-4 text-left text-gray-700 font-semibold">Status</th>
                <th className="p-4 text-left text-gray-700 font-semibold">Delivery</th>
                <th className="p-4 text-left text-gray-700 font-semibold">Payment</th>
            ...
            <tbody className="divide-y divide-gray-100">
              {filteredOrders.map((order, i) => (
                <tr key={order.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="p-4">
                    <div className="font-semibold text-gray-800">{order.crop}</div>
                  </td>
                  ...
                  <td className="p-4 text-sm text-gray-600">{order.delivery}</td>
                  <td className="p-4">
