...
export default function OrdersPage() {
  ...
  return (
    <div className="p-[.6rem] text-sm md:p-6  min-h-screen">
      {/* Header */}
      <div className="mb-8">
      ...
      {/* Pagination */}
      {filteredOrders.length > 0 && (
        <div className="flex flex-col bg-white sm:flex-row p-3 shadow justify-between items-center mt-5 gap-[.6rem] text-sm">
