      ...
      <div className="flex flex-wrap gap-3 mb-6 bg-white p-4 rounded shadow">
        {[
          ...
          <button
            key={i}
            onClick={btn.onClick}
            className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all duration-200 shadow-sm hover:shadow-md ${btn.color} font-medium`}
          >
