...
export default function LabourRequestsPage() {
  ...
  return (
    <div className="p-3 mt-4 bg-gray-100 min-h-[80vh]">
      <div className="bg-white rounded shadow-md">

        {/* HEADER */}
        <div className="flex justify-between items-center px-6 py-4 border-b border-z">
            ...
            <tbody className="divide-y">
              {paginatedRows.map((row) => (
                <tr key={row.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3">{row.requiredDate}</td>
        ...
        <div className="md:hidden p-3 space-y-2">
          {paginatedRows.map((row) => (
            <div
              key={row.id}
              className="bg-white rounded-lg border-zinc-400 shadow border p-4"
            >
