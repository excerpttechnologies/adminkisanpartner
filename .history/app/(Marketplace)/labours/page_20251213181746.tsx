            ...
            <tbody className="divide-y">
              {paginatedRows.map((row) => (
                <tr key={row.id} className="hover:bg-gray-50 ">
                  ...
                  <td className="px-4 py-1">{row.requiredDate}</td>
                  <td className="px-4 py-1">{row.male}</td>
                  <td className="px-4 py-1">{row.female}</td>
                  <td className="px-4 py-1">{row.crop}</td>
                  <td className="px-4 py-1">{row.work}</td>
