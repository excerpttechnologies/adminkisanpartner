...
export default function LabourRequestsPage() {
  ...
  const tableRef = useRe<HTMLDivElement>(null);
  ...
  const handleUpdate = async (data: any) => {
    ...
    try {
      ...
      setEditOpen(false);
      getLabours();
      alert("Labour request updated successfully!");
    } catch (error: any) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      setDeleteOpen(false);
      getLabours();
      alert("Labour request deleted successfully!");
    } catch (error: any) {
  ...
  const handleCreate = async (data: any) => {
    try {
      ...
      setAddOpen(false);
      getLabours();
      alert("Labour request created successfully!");
    } catch (error: any) {
      ...
      <div className="bg-white rounded shadow p-[.6rem] text-sm md:p-6 mb-6">
        <div className="gap-[.6rem] text-sm items-end flex flex-wrap md:flex-row flex-col md:*:w-fit *:w-full">
          ...
          <div className="md:col-span-4">
            <div className="relative">
              ...
              <input
                ...
                className="md:w-96 w-full pl-10 pr-4 py-3 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all"
              />
            </div>
          </div>
          ...
          <div className="md:col-span-2 flex gap-[.6rem] text-sm">
            ...
            <button
              onClick={() => getLabours()}
              className="flex-1 px-4 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all shadow-md hover:shadow-lg font-medium"
            >
              Apply
            </button>
          </div>
