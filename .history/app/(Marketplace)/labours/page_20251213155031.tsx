...
export default function LabourRequestsPage() {
  ...
  return (
    <div className="p-1 mt-4 bg-gray-100 min-h-screen pr-4">
      <div className="bg-white rounded shadow-md">
        ...
        <div className="md:hidden">
          {rows.map((row) => (
            <div key={row.id} className="border-b border-zinc-200 p-4 hover:bg-gray-50">
              <div className="flex justify-between items-start mb-3">
                <div>
                  <div className="font-medium text-gray-800">{row.farmerName}</div>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <div className="font-medium">{row.requiredDate}</div>
                </div>
                <div>
                ...
                <div>
                  <div className="text-xs text-gray-500">Male Required</div>
                  <div className="font-medium">{row.male}</div>
                </div>
                <div>
                  <div className="text-xs text-gray-500">Female Required</div>
                  <div className="font-medium">{row.female}</div>
                </div>
