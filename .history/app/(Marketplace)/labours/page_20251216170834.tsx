      ...
      <div className="bg-white rounded shadow p-[.6rem] text-sm md:p-6 mb-6">
        <div className="gap-[.6rem] text-sm items-end flex flex-wrap md:flex-row flex-col md:*:w-fit *:w-full">
          ...
          <div className="md:col-span-2 flex gap-[.6rem] text-sm">
            ...
            <button
              onClick={() => getLabours()}
              className="flex-1 px-4 py-3 bg-gradient-to-r from-green-600 to-green-600 text-white rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all shadow-md hover:shadow-lg font-medium"
            >
              Apply
            </button>
          </div>
