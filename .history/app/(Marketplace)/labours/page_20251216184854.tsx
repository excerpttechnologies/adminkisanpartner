...
export default function LabourRequestsPage() {
  ...
  return (
    <div className="p-[.6rem] relative text-black text-sm md:p-1 overflow-x-auto min-h-screen">
      ...
      {/* Filters Section */}
      <div className="bg-white rounded shadow p-[.6rem] text-sm md:p-3 mb-3">
      ...
      {labours.length > 0 && (
        <div className="flex flex-col bg-white sm:flex-row p-3 shadow justify-between rounded items-center mt-3 gap-[.6rem] text-sm">
