...
const Category = mongoose.models.CropCareCategory ||mongoose.model<ICropCareCategory>("CropCareCategory",CropCareCategorySchema);

const SubCategory =mongoose.models.CropCareSubCategory ||mongoose.model<ICropCareSubCategory>("CropCareSubCategory",CropCareSubCategorySchema);

const Product =mongoose.models.CropCareProduct ||mongoose.model<ICropCareProduct>("CropCareProduct",CropCareProductSchema
  );
