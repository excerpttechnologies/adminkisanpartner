...
export {
   ...
   SubCategory: mongoose.models.CropCareSubCategory || mongoose.model<ICropCareSubCategory>('CropCareSubCategory', CropCareSubCategorySchema),
   Product:mongoose.models.CropCareProduct || mongoose.model<ICropCareProduct>('CropCareProduct', CropCareProductSchema)
}