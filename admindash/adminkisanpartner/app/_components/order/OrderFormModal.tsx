...
export default function OrderFormModal({
  ...
  return (
    <Modal open={open} onClose={onClose}>
      <div className="bg-white rounded-xl w-[420px] *:p-3 *:border  max-h-[90vh] overflow-y-auto p-5 mx-auto mt-10 space-y-3">
        ...
        {/* ACTIONS */}
        <div className="flex justify-end gap-2 pt-3 *:p-2 text-white">
          <button onClick={onClose} className="btn-secondary bg-red-400">Cancel</button>
          <button onClick={handleSubmit} className="btn-primary bg-green-500">Save</button>
        </div>
      </div>
    </Modal>
  );
