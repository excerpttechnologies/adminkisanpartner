      ...
      <div className="mb-3">
        <div className="flex items-center md:justify-between gap-x-4 mb-4">
          ...
          <button
            ...
            className="flex items-center text-sm gap-2 px-3 py-2 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-medium rounded hover:from-green-700 hover:to-emerald-700 transition-all shadow-md"
          >
            ...
            <div className="relative flex lg:flex-row flex-col gap-x-3 gap-y-3">
             <div className="relative">
              ...
              <input
                ...
                className="w-96 lg:w-[40vw] pl-10 pr-4 py-2 text-sm sm:text-base border border-gray-300 rounded focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none"
              />
             </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 text-sm border border-gray-300 rounded focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none bg-white"
                    >
                  ...
                  <div className="sm:col-span-2 lg:col-span-1 flex items-end">
                    <button
                      ...
                      className="w-fit bg-green-400 px-4 py-2 text-sm   border border-green-300 text-white rounded font-bold hover:bg-green-600 cursor-pointer transition-colors font-medium"
                    >
                      Clear Filters
                    </button>
                  </div>
