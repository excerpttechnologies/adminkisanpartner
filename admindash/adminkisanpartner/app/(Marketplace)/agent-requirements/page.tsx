...
//     toast.className = `fixed top-4 right-4 px-6 py-2 rounded-lg shadow-lg text-white z-50 ${
...
//               <tr>
//                 <th className="px-6 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Date</th>
//                 <th className="px-6 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Category</th>
//                 <th className="px-6 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Sub-Category</th>
//                 <th className="px-6 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Farming Type</th>
//                 <th className="px-6 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Weight/Pack</th>
//                 <th className="px-6 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Qualities</th>
//                 <th className="px-6 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Location</th>
//                 <th className="px-6 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Status</th>
//                 <th className="px-6 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Actions</th>
//               </tr>
//             </thead>
      ...
      <div className="bg-white rounded shadow-md border border-gray-200 overflow-hidden">
        ...
        <div className="hidden xl:block overflow-x-auto">
          <table ref={tableRef} className="min-w-full">
            <thead className="bg-gray-50">
              <tr>
                <th className="px-6 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider w-10">
                  <input
                    type="checkbox"
                    checked={selectAll}
                ...
                <th className="px-6 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Date</th>
                <th className="px-6 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Category</th>
                <th className="px-6 xl:w-40 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Sub-Category</th>
                <th className="px-6 xl:w-40 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Farming Type</th>
                <th className="px-6 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Weight/Pack</th>
                <th className="px-6 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Qualities</th>
                <th className="px-6 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Location</th>
                <th className="px-6 py-2 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Status</th>
